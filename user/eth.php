...
if(isset($_POST['submit'])){
    ...
    $btc =$link->real_escape_string( $_POST['eth']);
    ...
    Your deposit of '.$usd.' USD worth of '.$btc.'  ETH is currently under review, your transaction ID is '.$tnx.' , your balance will be credited once your deposit is confirmed.
    ...
    Copyright ©2020 '.$name.'. </p> <div class="be_logo" style=" width:60px;height:40px;float: right;"> </div> </div> </div> </div></div>' ;
      ...
      if($mail->send()){
        ...
        $msg= " Your deposit of $usd USD worth of $btc  ETH is currently under reviews, your transaction ID is $tnx , your balance will be credited once your deposit is confirmed. ";
      }
...
?>
                            ...
                            <div class="col-md-12">
                                ...
                                <p style="text-align: center;">
                                                    <b>Ethereum Payment Process</b></p>
                                                ...
                                                <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Value in ETH is displayed here</label>
                                                                    <input type="double" id="eth" name="eth" class="form-control" placeholder="Value in BTC is displayed here" readonly>
